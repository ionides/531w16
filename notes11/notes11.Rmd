---
title: "11. Introduction to partially observed Markov process models"
...
* Many applications arise in epidemiology, studying the transmission of infectious diseases.
    ...
    + Infectious disease dynamics can be highly nonlinear. This arises primarily because transmission arises when an infected individual contacts a susceptible individual, which should happen at a rate proportional to 
$$ \mbox{Fraction of individuals infected} \times \mbox{Fraction of individuals susceptible}$$
and secondarily because each new infection depletes the pool of susceptible individuals. 
    ...
    + These class notes derive from a course on [Simulation-based Inference for Epidemiological Dynamics](http://kingaa.github.io/sbied/).
...
We'll illustrate this process a dataset of *Parus major* abundance in Wytham Wood, near Oxford [@mccleery91].
