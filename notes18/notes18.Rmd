---
title: "18. Time series models with covariates, and a case study of polio"
...
* When the process leading to  ${z_{1:N}}$ is not external to the system generating it, we must be alert to the possibility of **reverse causation** and **confounding variables**, discussed in [Section 10.3](http://ionides.github.io/531w16/notes10/notes10.html#conclusions). 
