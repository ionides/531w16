...
[SS3] $\myeq{
\log f_{X_{1:N}Y_{1:N}}(x_{1:N},y_{1:N} \params \sigma,\lambda) = \frac{-1}{2\sigma^2} \sum_{n-1}^N(y_n-x_n)^2 +\frac{-\lambda}{2\sigma^2}  \sum_{n=3}^T(\Delta^2 x_n)^2 + C
}$.
...
\exp
  \left\{-
     \frac{x\, \big[\Sigma_X\big]^{-1} \, x^\transpose}{2}
  \right\}.
$$
...
\\
X_n\given Y_{1:N}\equals y_{1:N} &\sim& N\big[ \mu_n^S(y_{1:N}),\Sigma_n^F\big].
\end{array}$
