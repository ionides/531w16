...
* Here is some feedback on the project from the scientist:
...
* Based on the discussion last class, we should add to this feedback that it is also necessary to give proper acknowledgement to the source. 
