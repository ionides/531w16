...
* Recall the daily S&P 500 data that we saw earlier, in [Section 3.5](http://ionides.github.io/531w16/notes3/notes3.html#a-random-walk-model), downloaded from [yahoo.com](http://real-chart.finance.yahoo.com/table.csv?s=%5EGSPC&d=0&e=15&f=2016&g=d&a=0&b=3&c=1950&ignore=.csv).
...
* We saw, in [Section 3.5](http://ionides.github.io/531w16/notes3/notes3.html#a-random-walk-model), that $\data{y_{2:N}}$ has negligible sample autocorrelation.
...
* Look at the plots in  [Section 3.5](http://ionides.github.io/531w16/notes3/notes3.html#a-random-walk-model). 
...
These notes were developed from a tutorial on [financial leverage analysis in pomp](http://dept.stat.lsa.umich.edu/~ionides/tutorials/sp500/sp500.html).
