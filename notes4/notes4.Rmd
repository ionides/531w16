...
<br><br>
[M7] $\eqspace X_n = \mu + g_0\epsilon_n + g_1\epsilon_{n-1}+g_2\epsilon_{n-2}+g_3\epsilon_{n-3} + g_4\epsilon_{n-4}+\dots$
<br><br>
...
<br><br>
[M8] $\eqspace X_n = \ar X_{n-1}+\epsilon_n$.
<br><br>

* This has a causal solution,
<br><br>
[M8.1] $\eqspace X_n = \sum_{j=0}^\infty \ar^j\epsilon_{n-j}$.
<br><br>
...
$$
 X_n - \ar_1 X_{n-1}- \ar_2X_{n-2}-\dots-\ar_pX_{n-p} = \epsilon_n,
$$
which is equivalent to
<br><br>
[M1$^\prime$] $\eqspace \ar(B) X_n = \epsilon_n$.
<br><br>
...
<br><br>
[M3$^\prime$] $\eqspace X_n = \ma(B) \epsilon_n$.
<br><br>
...
<br><br>
[M7$^\prime$] $\eqspace X_n = \mu + g(B)\epsilon_n$.
<br><br>
...
<br><br>
[M9] $\eqspace X_n = \ar_1 X_{n-1}+\ar_2X_{n-2}+\dots+\ar_pX_{n-p} + \epsilon_n +\ma_1 \epsilon_{n-1} +\dots+\ma_q\epsilon_{n-q}$,
<br><br>
where $\{\epsilon_n\}$ is a white noise process. Using the backshift operator, we can write this more succinctly as
<br><br>
[M9$^\prime$] $\eqspace \ar(B) X_n = \ma(B) \epsilon_n$.
<br><br>
...
$$ X_n = \ar X_{n-1} + \epsilon_n + \ma \epsilon_{n-1}.$$

1. Formally, we can write 
$$   (1-\ar B)X_n = (1+\ma B)\epsilon_n,$$
which algebraically is equivalent to 
$$X_n = \left(\frac{1+\ma B}{1-\ar B}\right)\epsilon_n.$$
We write this as
$$X_n = g(B) \epsilon_n,$$
where
