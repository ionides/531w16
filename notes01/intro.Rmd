...
* Write the data as $y^*_1,\dots,y^*_N$. 

* A basic estimate of the mean and standard deviation is $\data{\mu}= \frac{1}{N}\sum_{n=1}^Ny^*_n$ and $\data\sigma= \sqrt{\frac{1}{N-1}\sum_{n=1}^N(y^*_n-\data{\mu})^2}$, suggesting an approximate confidence interval for $\mu$ of $\data{\mu}\pm 1.96\data{\sigma}/\sqrt{N}$, 
...
$$\predict{y_n} = \data{\mu} + \data{\alpha}(\data{y_{n-1}}-\data{\mu}).$$
