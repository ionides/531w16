...
15. [Case study: POMP modeling to investigate financial volatility](notes15/notes15.html). 

16. [Using a Linux sever for POMP analysis](linux/linux.html).
...
* [Homework 8](hw/hw08.html), due on 3/29. [Reponses to time survey](hw/summary08.html).

* [Homework 9](hw/hw09.html), due on 4/7.
