...
6. [Extending the ARMA model: Seasonality and trend](notes6/notes6.html). [(R script)](notes5/notes5.R)
...
* [Homework 3](hw/hw03.html), due midnight on 2/2. 

------------

## Midterm exam information

The midterm exam will involve reasoning about a data analysis using the theoretical and computational techniques we have studied in class. The best predictor of the style of the exam may be the following two past papers from a somewhat similar course:
