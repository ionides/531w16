...
\\
\hat{\gamma}_{0}\left(x_{1:N}\right)&=&\frac{1}{N}\sum_{n=1}^{N-h}x_{n}^{2}.
\end{eqnarray}$$
We let $\sum_{n=1}^{N-h}X_{n}X_{n+h}=U$ and $\sum_{n=1}^{N-h}X_{n}^{2}=V$, and carry out a Taylor first order expansion of 
